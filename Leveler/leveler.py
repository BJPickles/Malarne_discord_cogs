...
class Leveler(commands.Cog):
    ...
    @levelerset.command()
    @commands.has_any_role('Moderator', '91AR Officer', '91AR Subcommander', 'Developer', 'Bot Developer', "Bot Developer", 'Mod Team', 'Administrator', 'Corporal', 'Corporal I', 'Corporal II', 'Corporal III', 'Corporal IV', 'Lieutenant', 'Lieutenant I', 'Lieutenant II', 'Lieutenant III', 'Lieutenant IV', 'Lieutenant V')
    @commands.guild_only()
